...
\node[align=center,text=teal,font=\scriptsize\bfseries] at (1.65,2.76)
  {labor task mass\\grows};
\node[align=center,text=orange!75!black,font=\scriptsize\bfseries] at (3.55,.86)
  {labor task mass\\falls};
\node[fill=white,inner sep=1pt,font=\scriptsize] at (3.45,2.88)
  {$\Delta N=\Delta I$};
\fill[teal] (1.95,2.5) circle (2.2pt);
\fill[orange!80!black] (1.95,.8) circle (2.2pt);
\end{tikzpicture}
\column{.42\textwidth}
\[\Delta m_L=\Delta N-\Delta I.\]
\vspace{-.3em}
\begin{block}{Two examples}
$\Delta I=.15$, $\Delta N=.25$: labor task mass grows by $.10$.\\[.25em]
$\Delta I=.15$, $\Delta N=.08$: it falls by $.07$.
\end{block}
\end{columns}
\vspace{.2em}
