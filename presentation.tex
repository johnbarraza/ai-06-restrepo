...
\end{itemize}
\vspace{.4em}
The resulting aggregate production function has technology-dependent capital and labor weights (Proposition 1).
\end{frame}
...
\[x=p+(1-s_L)(x-z).\]
Substituting (B10) gives the Proposition 3 wage decomposition. This two-equation algebra is the natural Lean target.
\end{frame}
...
\IfFileExists{lean-slides.tex}{\input{lean-slides.tex}}{%
